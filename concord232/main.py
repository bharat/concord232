...
""",
    ...
    # Do NOT rewrite these as config.get(section, {}): ConfigParser.get is
    # get(section, option), so the dict-style default becomes an option name
    # and crashes with AttributeError at startup (SIM401 is a false positive
    # here and is ignored in pyproject.toml).
